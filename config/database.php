    ...
    */
    ...
    'connections' => [
        ...
        'server25stamp' => [
            ...
            'port' => env('STDB_PORT', '3306'),
            'database' => env('STDB_DATABASE', 'laravel'),
            'username' => env('STDB_USERNAME', 'root'),
            'password' => env('STDB_PASSWORD', ''),
            'unix_socket' => env('STDB_SOCKET', ''),
            'charset' => env('STDB_CHARSET', 'utf8mb4'),
            'collation' => env('STDB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
        ...
        'server26' => [
            'driver' => 'mariadb',
            'url' => env('MTDB_URL'),
            'host' => env('MTDB_HOST', '127.0.0.1'),
            'port' => env('MTDB_PORT', '3306'),
            'database' => env('MTDB_DATABASE', 'laravel'),
            'username' => env('MTDB_USERNAME', 'root'),
            'password' => env('MTDB_PASSWORD', ''),
            'unix_socket' => env('MTDB_SOCKET', ''),
            'charset' => env('MTDB_CHARSET', 'utf8mb4'),
            'collation' => env('MTDB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
